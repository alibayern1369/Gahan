-- ============================================================
-- گاهان | Migration 0007 — Multi-workplace attendance matching
-- Employees may be assigned multiple locations; check-in succeeds
-- when GPS is within ANY assigned active workplace radius.
-- ============================================================
...
-- Patch submit_attendance workplace resolution only (full body replaced for clarity)
